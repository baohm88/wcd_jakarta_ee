...
<%
    ...
    RegisterInfo registerInfo = (RegisterInfo) request.getAttribute("registerInfo");
...
<head>
    ...
    <style>
        ...
        .field-error { color:#b10000; font-size: 13px; margin-top: 4px; }
...
<form action="<%= request.getContextPath() %>/register" method="post">
    <div>
        ...
        <div class="field-error"><%= err(errors,"username") %></div>
        <% } %>
    </div>
    ...
    <div>
        ...
        <div class="field-error"><%= err(errors,"email") %></div>
        <% } %>
    </div>
    ...
    <div>
        ...
        <div class="field-error"><%= err(errors,"password") %></div>
        <% } %>
    </div>
    ...
    <div>
        ...
        <div class="field-error"><%= err(errors,"confirmPassword") %></div>
        <% } %>
    </div>
